...
describe('Feedback Correspondents', () => {
  ...
  it('can access new survey window and the form is rendered correctly', () => {
    ...
    cy.get('[data-cy="formik-student-number-input-expand-button"]').should('be.visible')
    ...
    cy.get('[data-cy="formik-student-number-input-expand-button"]').click()
  ...
  it('can create questions for organisation survey', () => {
    ...
    cy.get('[id="likert-label-en-questions.0"]').clear()
    cy.get('[id="likert-label-en-questions.0"]').type('Rate the importance of testing')
...
describe('Responsible Teachers', () => {
  ...
  it('can create questions for organisation survey', () => {
    ...
    cy.get('[data-cy="question-editor-add-question"]').click()
    cy.get('[data-cy="question-editor-type-menu-select-likert"]').click()
    cy.get('[id="likert-label-en-questions.0"]').as('likertQuestion').clear()
