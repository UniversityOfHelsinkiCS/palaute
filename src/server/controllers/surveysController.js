...
const update = async (req, res) => {
  ...
  const { data, questions, name, hidden, opensAt, closesAt } = req.body
  ...
  if (hidden) survey.hidden = hidden
  if (opensAt) survey.opensAt = opensAt
  if (closesAt) survey.closesAt = closesAt
