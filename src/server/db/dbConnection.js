...
const { DB_CONNECTION_STRING, inProduction, inStaging } = require('../util/config')

const DB_CONNECTION_RETRY_LIMIT = 10

const sequelize = new Sequelize(DB_CONNECTION_STRING, { logging: inProduction || inStaging })
