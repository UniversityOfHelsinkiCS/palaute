...
export const INCLUDE_COURSES = config.get<string[]>('INCLUDE_COURSES') ?? []
...
export const PATE_URL = config.get<string>('PATE_URL')
export const JAMI_URL = inProduction && !inStaging ? config.get<string>('JAMI_URL') : `http://${JAMI_HOST}:${JAMI_PORT}`
export const PUBLIC_URL = config.get<string>('PUBLIC_URL')
export const OPEN_UNIVERSITY_ORG_ID = config.get<string>('OPEN_UNIVERSITY_ORG_ID')
export const UNIVERSITY_ROOT_ID = config.get<string>('UNIVERSITY_ROOT_ID')
export const SUMMARY_EXCLUDED_ORG_IDS = config.get<string[]>('SUMMARY_EXCLUDED_ORG_IDS')
export const SUMMARY_SKIP_ORG_IDS = config.get<string[]>('SUMMARY_SKIP_ORG_IDS')
export const FEEDBACK_RESPONSE_EMAILS_SINCE_DATE = new Date(config.get('FEEDBACK_RESPONSE_EMAILS_SINCE_DATE'))
...
export const SURVEY_OPENING_EMAILS_CHUNK_MAX_SIZE = config.get<number>('SURVEY_OPENING_EMAILS_CHUNK_MAX_SIZE')
