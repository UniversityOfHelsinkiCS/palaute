...
export const WORKLOAD_QUESTION_ID_ORDER = config.get('WORKLOAD_QUESTION_ID_ORDER') ?? []
export const DEV_ADMINS = config.get('DEV_ADMINS') ?? []
export const INCLUDE_COURSES = config.get('INCLUDE_COURSES') ?? []
export const TAGS_ENABLED = config.get('TAGS_ENABLED') ?? []
...
export const IAM_GROUPS_HEADER = config.get('IAM_GROUPS_HEADER')
export const TRANSLATION_NAMESPACE = config.get('TRANSLATION_NAMESPACE')
export const LANGUAGES = config.get('LANGUAGES')
export const GELF_TRANSPORT_ENABLED = config.get('GELF_TRANSPORT_ENABLED') ?? false
export const SENTRY_DSN = config.get('BACKEND_SENTRY_DSN')
...
export const FEEDBACK_CORRESPONDENT_SPECIAL_GROUP = config.get('FEEDBACK_CORRESPONDENT_SPECIAL_GROUP')
