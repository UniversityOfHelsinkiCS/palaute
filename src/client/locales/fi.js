...
export default {
  ...
  feedbackTargetResults: {
    ...
    teacherAccessInfo:
      'Sinulla on opettajan käyttöoikeudet kurssille, joten näet vastaukset vain julkiseksi asetettuihin kysymyksiin. Jos tarvitset laajemman näkyvyyden pyydä vastuuopettajan roolia Sisussa.',
  ...
  feedbackTargetView: {
    ...
    closeRespondContinuousFeedback: 'Sulje',
