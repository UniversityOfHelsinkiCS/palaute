...
import useSurveyByCourseCode from '../../hooks/useSurveyByCourseCode'
...
const EditCourseUnitSurvey = () => {
  ...
  const { survey, isLoading: surveyIsLoading } = useSurveyByCourseCode(code, {
    cacheTime: 0,
  })
...
export default EditCourseUnitSurvey
