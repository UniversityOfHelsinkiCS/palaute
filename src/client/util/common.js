...
export const SHOW_NORPPA_HY_LOGO = config?.SHOW_NORPPA_HY_LOGO

export const SHOW_COURSES_TAB_IN_ORGANISATION_SETTINGS = config?.SHOW_COURSES_TAB_IN_ORGANISATION_SETTINGS

export const SHOW_CHITS_AT_COURSE_UNIT_LEVEL_IN_ACCORDIONS = config?.SHOW_CHITS_AT_COURSE_UNIT_LEVEL_IN_ACCORDIONS
